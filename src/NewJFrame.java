...
try{
            ...
            String query="create table a"+create.getText()+"(sno int primary key, txn varchar(15) not null, date date, remarks varchar(50) not null, credit varchar(15) not null, debit varchar(15) not null, balance varchar(20) not null, fromacc varchar(15), toacc varchar(15));";
            stmt.execute(query);
